...
public class MemeManager extends TelegramLongPollingBot {
  ...
  private Void processMeme(Update update) {
    ...
    CompletableFuture.supplyAsync(() -> Try.of(() -> execute(
            new SendPhoto()
                    .setChatId(chatId)
      ...
      return CompletableFuture.supplyAsync(() -> memeRepository.save(meme));
    });
  ...
  private Void processVote(Update update) {
    ...
    final CompletableFuture<MemeEntity> memeFuture =
            CompletableFuture.supplyAsync(() -> memeRepository.findById(message.getPhoto().get(0).getFileId()).orElseThrow());
    ...
    memeFuture
            .thenCompose(meme -> {
              ...
              return CompletableFuture.supplyAsync(() -> {
                ...
                return null;
              }).thenCompose(notUsed -> CompletableFuture.supplyAsync(() -> Try.of(
                      () ->
                              execute(
